...
import pl.jacekplacek.ideasPro.common.dto.StatisticsDto;
...
public interface QuestionRepository extends JpaRepository<Question, UUID> {
    ...
    @Query("from Question q where q.answers is empty")
    ...
    @Query(value = "select new pl.jacekplacek.ideasPro.common.dto.StatisticsDto(count(q), count(a)) from Question q join q.answers a")
